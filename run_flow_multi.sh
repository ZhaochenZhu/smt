...
for entry in "$testcase_dir"/*; do
  pinLayoutWargs+="$workdir/scripts/genSMTInput_Ver2.6_cfet.pl $entry 0 1 0 1 1 1 1 2 3 4 1 2 1 0 0 1 1 1 2"$'\n'
...
# $pinLayoutWargs | xargs -P 16 -n 20 $workdir/scripts/genSMTInput_Ver2.6_cfet.pl
